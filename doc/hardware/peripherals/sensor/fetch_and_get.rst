...
See :kconfig:BMI160_TRIGGER_NONE:, :kconfig:BMI_TRIGGER_GLOBAL_THREAD:
(work queue), :kconfig:BMI160_TRIGGER_OWN_THREAD (dedicated thread).
...
.. note::
   In all cases its very likely there will be variable delays from the actual
...
.. literalinclude:: ../../../../samples/sensor/tap_count/src/main.c
   :language: c
